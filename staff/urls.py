...
urlpatterns = [
    ...
    path('companies/', products.company_list, name='company_list'),
    path('companies/add/', products.company_add, name='company_add'),
    path('companies/<int:pk>/edit/', products.company_edit, name='company_edit'),
    path('companies/<int:pk>/delete/', products.company_delete, name='company_delete'),
    ...
    path('products/import/status/', products.import_products_status, name='import_products_status'),
    ...
    path('products/import/commit-status/', products.import_products_commit_status, name='import_products_commit_status'),
    path('products/import/commit-result/', products.import_products_commit_result, name='import_products_commit_result'),
    ...
    path('products/export/status/', products.export_products_status, name='export_products_status'),
    path('products/export/download/', products.export_products_download, name='export_products_download'),
    ...
    path('reports/export/processing/', reports.reports_export_processing, name='reports_export_processing'),
    path('reports/export/status/', reports.reports_export_status, name='reports_export_status'),
    path('reports/export/download/', reports.reports_export_download, name='reports_export_download'),
