...
from staff.views import dashboard, inventory, clients, products, orders, accounting, employees, account_types, reports, tags, activity, followups, backup
...
urlpatterns = [
    ...
    path('products/<int:pk>/variants/search/', products.product_variant_search, name='product_variant_search'),
    path('products/<int:pk>/variants/link/', products.product_variant_link, name='product_variant_link'),
    path('products/<int:pk>/variants/<int:target_pk>/unlink/', products.product_variant_unlink, name='product_variant_unlink'),
